...
export const SEED_MEDIA: SeedMedia[] = [
  ...
  plate("sheet-mark", "Loomie's mark drawn on its construction geometry", 99000),
  plate("sheet-type", "A type specimen sheet showing the display face at three sizes", 138000),
  plate("sheet-grid", "A twelve-column layout grid with a page part-placed on it", 161000),
  plate("sheet-tone", "A tonal ramp running from deep blue through to warm off-white", 175000),
  plate("sheet-structure", "A page structure diagram: regions blocked out and annotated", 128000),
  plate("sheet-campaign", "A campaign sheet: one line and one mark as a poster, a square and a banner", 114000),
  plate("sheet-interface", "A built page shown at desktop and phone width", 224000),
  plate("sector-architecture", "Drawing conventions and material, set on a sheet", 120000),
  plate("sector-objects", "A mark applied to an object, at the sizes it has to survive", 120000),
  plate("sector-hardware", "One component set across a panel, a screen and a box", 120000),
  plate("sector-trade", "A specification table, set to be used rather than admired", 120000),
];
...
export const SEED_SERVICES: SeedService[] = [
  {
    ...
    number: "01",
    title: "Identity",
    shortDescription: "Marks and systems made to stay recognisable.",
    heroLabel: "Identity / Mark / System",
    heroDescription: "Drawn from its own geometry.",
    visualKey: "sheet-type",
    heroKey: "sheet-mark",
  },
  {
    slug: "web-identity",
    number: "02",
    title: "Web identity",
    shortDescription: "Rules for type, colour and layout across digital surfaces.",
    heroLabel: "Web identity / Type / Tone",
    heroDescription: "One scale, one ramp, everywhere.",
  ...
  },
  {
    ...
    heroLabel: "Websites / Layout / Interface",
