...
/**
 * The presentation half of the footer.
 *
 * Split from Footer so the wordmark animation can stay in a Client Component
 * while the addresses and social links are read on the server. Everything the
 * footer says about the studio is now a row rather than a constant here.
 *
 * The Elsewhere column renders only when an account has actually been enabled
 * with a URL. Linking to instagram.com as though it were the studio's own is a
 * broken promise on every click.
 */
