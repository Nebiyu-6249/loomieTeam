...
/**
 * The presentation half of the navigation.
 *
 * Split from Navbar so the scroll behaviour and the overlay can stay in a
 * Client Component while the studio's address is read on the server. The
 * address is a setting, so changing it is one edit in the admin.
 */
export function NavbarView({ contactEmail }: { contactEmail: string }) {
